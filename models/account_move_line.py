...
class AccountMoveLine(models.Model):
    ...
    grupo_id= fields.Many2one('intercompany.cost.groups',string='Grupo costo', compute="_search_grupo_account")
    subgrupo_id = fields.Many2one('intercompany.cost.subgroups', string='Subgrupo costo', compute="_search_subgrupo_account")
