...
#        _logger.info('revenue_interco_total_mkt:' + str(self.revenue_interco_total_mkt))
    ...
    # ---------------- PROCESO comisiones UN  -----------------
       ...
       #         _logger.info('GRUPO:' + grupo.name + 'CUENTAS MEX:' + str(cuentas_usa))
        ...
        if comisiones:
            ...
            self.ci_total = round(self.ci_mex + self.ci_usa,2)
    ...
    def post(self):
      ...
      #  _logger.info('----Diario de asiento final:' + pdiario)
        ...
        cuentas = self.env['type.results'].search([('resultado', '=', 'RECRUITING')], limit=1)
        for ctas in cuentas:
        ...
        #--------------------------------------------------#
        cuentas = self.env['type.results'].search([('resultado', '=', 'MKT')], limit=1)
        _logger.info('----CUENTAS:' + cuentas)
        for ctas in cuentas:                        
        ...
        # --------------------------------------------------#
        cuentas = self.env['type.results'].search([('resultado', '=', 'OP')], limit=1)
        for ctas in cuentas:
        ...
        # --------------------------------------------------#
        cuentas = self.env['type.results'].search([('resultado', '=', 'CI')], limit=1)
        for ctas in cuentas:
        ...
        # --------------------------------------------------#
        cuentas = self.env['type.results'].search([('resultado', '=', 'SALES')], limit=1)
        for ctas in cuentas:
        ...
        # --------------------------------------------------#
        cuentas = self.env['type.results'].search([('resultado', '=', 'PRESALES')], limit=1)
        for ctas in cuentas:
        ...
        # --------------------------------------------------#
        cuentas = self.env['type.results'].search([('resultado', '=', 'CI-UN')], limit=1)
        for ctas in cuentas:
        ...
        #--------------------------------------------------------
        cuentas = self.env['type.results'].search([('resultado', '=', 'LEADS MKT')], limit=1)
        for ctas in cuentas:
